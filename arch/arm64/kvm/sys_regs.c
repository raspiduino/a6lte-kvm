...
/*
 * This file is backported from Linux v5.4 with some changes
 * The base kernel version is Linux v3.19.81 for AOSP
 */
...
#define vcpu_has_sve(vcpu) 0 // No we don't have SVE on our Cortex-A53 :(

// Delivered from arch/arm64/include/asm/perf_event.h
...
// Delivered from virt/kvm/arm/arch_timer.c
...
/*
 * Below is the original content from Linux 5.4's sys_regs.c
